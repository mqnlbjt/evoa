...
export class StatsAccumulator {
	...
	private runSnapshot(now: number | undefined, latency: LatencySummary): StatsSnapshot["runs"] {
		return {
			count: this.runCount,
	...
	private modelSnapshot(): StatsSnapshot["model"] {
	...
	private toolSnapshot(latency: LatencySummary): StatsSnapshot["tools"] {
		return {
	...
	private scoreSnapshot(): StatsSnapshot["scores"] {
		return {
